...
namespace LLVM.Generated
    ...
    module Core =
        ...
        type TypeHandleRef (thePtr : nativeint) =
            member x.Ptr with get() = (x :> ILLVMRef).Ptr
            interface ILLVMRef with member x.Ptr with get() = thePtr
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetMDKindID")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMModuleCreateWithNameInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetTarget")>]
        extern void* getTargetNative(
            void* (* LLVMModuleRef *) M)
        let getTarget _M =
            Marshal.PtrToStringAuto (getTargetNative ((_M : ModuleRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetTarget")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddTypeName")>]
        extern bool addTypeNameNative(
            void* (* LLVMModuleRef *) M,
            string Name,
            void* (* LLVMTypeRef *) Ty)
        let addTypeName _M _Name _Ty =
            addTypeNameNative ((_M : ModuleRef).Ptr, _Name, (_Ty : TypeRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDeleteTypeName")>]
        extern void deleteTypeNameNative(
            void* (* LLVMModuleRef *) M,
            string Name)
        let deleteTypeName _M _Name =
            deleteTypeNameNative ((_M : ModuleRef).Ptr, _Name)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetTypeByName")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetTypeName")>]
        extern void* getTypeNameNative(
            void* (* LLVMModuleRef *) M,
            void* (* LLVMTypeRef *) Ty)
        let getTypeName _M _Ty =
            Marshal.PtrToStringAuto (getTypeNameNative ((_M : ModuleRef).Ptr, (_Ty : TypeRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDumpModule")>]
        extern void dumpModuleNative(
            void* (* LLVMModuleRef *) M)
        let dumpModule _M =
            dumpModuleNative ((_M : ModuleRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetModuleInlineAsm")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetModuleContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInt8TypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInt16TypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInt32TypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInt64TypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMIntTypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMFloatTypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDoubleTypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMX86FP80TypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMFP128TypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMPPCFP128TypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMIsFunctionVarArg")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetReturnType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMStructTypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMStructType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCountStructElementTypes")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMPointerType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMVectorType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetPointerAddressSpace")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetVectorSize")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMVoidTypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMLabelTypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMOpaqueTypeInContext")>]
        extern void* (* LLVMTypeRef *) opaqueTypeInContextNative(
            void* (* LLVMContextRef *) C)
        let opaqueTypeInContext _C =
            new TypeRef (opaqueTypeInContextNative ((_C : ContextRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMX86MMXTypeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMVoidType")>]
        extern void* (* LLVMTypeRef *) voidTypeNative()
        let voidType () =
            new TypeRef (voidTypeNative ())

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMLabelType")>]
        extern void* (* LLVMTypeRef *) labelTypeNative()
        let labelType () =
            new TypeRef (labelTypeNative ())

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMOpaqueType")>]
        extern void* (* LLVMTypeRef *) opaqueTypeNative()
        let opaqueType () =
            new TypeRef (opaqueTypeNative ())

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMX86MMXType")>]
        extern void* (* LLVMTypeRef *) x86MMXTypeNative()
        let x86MMXType () =
            new TypeRef (x86MMXTypeNative ())

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateTypeHandle")>]
        extern void* (* LLVMTypeHandleRef *) createTypeHandleNative(
            void* (* LLVMTypeRef *) PotentiallyAbstractTy)
        let createTypeHandle _PotentiallyAbstractTy =
            new TypeHandleRef (createTypeHandleNative ((_PotentiallyAbstractTy : TypeRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRefineType")>]
        extern void refineTypeNative(
            void* (* LLVMTypeRef *) AbstractTy,
            void* (* LLVMTypeRef *) ConcreteTy)
        let refineType _AbstractTy _ConcreteTy =
            refineTypeNative ((_AbstractTy : TypeRef).Ptr, (_ConcreteTy : TypeRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMResolveTypeHandle")>]
        extern void* (* LLVMTypeRef *) resolveTypeHandleNative(
            void* (* LLVMTypeHandleRef *) TypeHandle)
        let resolveTypeHandle _TypeHandle =
            new TypeRef (resolveTypeHandleNative ((_TypeHandle : TypeHandleRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposeTypeHandle")>]
        extern void disposeTypeHandleNative(
            void* (* LLVMTypeHandleRef *) TypeHandle)
        let disposeTypeHandle _TypeHandle =
            disposeTypeHandleNative ((_TypeHandle : TypeHandleRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMTypeOf")>]
        extern void* (* LLVMTypeRef *) typeOfNative(
            void* (* LLVMValueRef *) Val)
        let typeOf _Val =
            new TypeRef (typeOfNative ((_Val : ValueRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetValueName")>]
        extern void* getValueNameNative(
            void* (* LLVMValueRef *) Val)
        let getValueName _Val =
            Marshal.PtrToStringAuto (getValueNameNative ((_Val : ValueRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetValueName")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDumpValue")>]
        extern void dumpValueNative(
            void* (* LLVMValueRef *) Val)
        let dumpValue _Val =
            dumpValueNative ((_Val : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMReplaceAllUsesWith")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMHasMetadata")>]
        extern int hasMetadataNative(
            void* (* LLVMValueRef *) Val)
        let hasMetadata _Val =
            hasMetadataNative ((_Val : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetMetadata")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetMetadata")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetOperand")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMMDStringInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMMDString")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMMDNodeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstIntOfArbitraryPrecision")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstIntOfString")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstIntOfStringAndSize")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstReal")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstRealOfString")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstRealOfStringAndSize")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstIntGetZExtValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstIntGetSExtValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstStringInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstStructInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstString")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstArray")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstStruct")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstVector")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetConstOpcode")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstNUWNeg")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstNSWAdd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstNUWAdd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFAdd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstNSWSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstNUWSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstNSWMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstNUWMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstUDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstSDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstExactSDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstURem")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstSRem")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFRem")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstAnd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstOr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstXor")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstICmp")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFCmp")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstShl")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstLShr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstAShr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstGEP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstInBoundsGEP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstTrunc")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstSExt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstZExt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFPTrunc")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFPExt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstUIToFP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstSIToFP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFPToUI")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFPToSI")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstPtrToInt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstIntToPtr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstZExtOrBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstSExtOrBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstTruncOrBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstPointerCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstIntCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstFPCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstSelect")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstExtractElement")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstInsertElement")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstShuffleVector")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstExtractValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstInsertValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMConstInlineAsm")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBlockAddress")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetGlobalParent")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetVisibility")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetVisibility")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetAlignment")>]
        extern uint32 getAlignmentNative(
            void* (* LLVMValueRef *) Global)
        let getAlignment _Global =
            getAlignmentNative ((_Global : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetAlignment")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddGlobal")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddGlobalInAddressSpace")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetNamedGlobal")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetPreviousGlobal")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDeleteGlobal")>]
        extern void deleteGlobalNative(
            void* (* LLVMValueRef *) GlobalVar)
        let deleteGlobal _GlobalVar =
            deleteGlobalNative ((_GlobalVar : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetInitializer")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetInitializer")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMIsThreadLocal")>]
        extern bool isThreadLocalNative(
            void* (* LLVMValueRef *) GlobalVar)
        let isThreadLocal _GlobalVar =
            isThreadLocalNative ((_GlobalVar : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetThreadLocal")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddAlias")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetNamedFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetFirstFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetPreviousFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetGC")>]
        extern void* getGCNative(
            void* (* LLVMValueRef *) Fn)
        let getGC _Fn =
            Marshal.PtrToStringAuto (getGCNative ((_Fn : ValueRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetGC")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddFunctionAttr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetFunctionAttr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRemoveFunctionAttr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetParamParent")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetPreviousParam")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddAttribute")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRemoveAttribute")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBasicBlockAsValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMValueIsBasicBlock")>]
        extern bool valueIsBasicBlockNative(
            void* (* LLVMValueRef *) Val)
        let valueIsBasicBlock _Val =
            valueIsBasicBlockNative ((_Val : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMValueAsBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetBasicBlockParent")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCountBasicBlocks")>]
        extern uint32 countBasicBlocksNative(
            void* (* LLVMValueRef *) Fn)
        let countBasicBlocks _Fn =
            countBasicBlocksNative ((_Fn : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetBasicBlocks")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetFirstBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetLastBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetNextBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetPreviousBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetEntryBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAppendBasicBlockInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInsertBasicBlockInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAppendBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInsertBasicBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDeleteBasicBlock")>]
        extern void deleteBasicBlockNative(
            void* (* LLVMBasicBlockRef *) BB)
        let deleteBasicBlock _BB =
            deleteBasicBlockNative ((_BB : BasicBlockRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMMoveBasicBlockBefore")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMMoveBasicBlockAfter")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetInstructionParent")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetFirstInstruction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetLastInstruction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetNextInstruction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetPreviousInstruction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetInstructionCallConv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetInstructionCallConv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddInstrAttribute")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRemoveInstrAttribute")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetInstrParamAlignment")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddIncoming")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCountIncoming")>]
        extern uint32 countIncomingNative(
            void* (* LLVMValueRef *) PhiNode)
        let countIncoming _PhiNode =
            countIncomingNative ((_PhiNode : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetIncomingValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetIncomingBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateBuilderInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateBuilder")>]
        extern void* (* LLVMBuilderRef *) createBuilderNative()
        let createBuilder () =
            new BuilderRef (createBuilderNative ())

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMPositionBuilder")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMPositionBuilderBefore")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMPositionBuilderAtEnd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetInsertBlock")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMClearInsertionPosition")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInsertIntoBuilder")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInsertIntoBuilderWithName")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposeBuilder")>]
        extern void disposeBuilderNative(
            void* (* LLVMBuilderRef *) Builder)
        let disposeBuilder _Builder =
            disposeBuilderNative ((_Builder : BuilderRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetCurrentDebugLocation")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetCurrentDebugLocation")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMSetInstDebugLocation")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildRetVoid")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildRet")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildAggregateRet")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildBr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildCondBr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSwitch")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildIndirectBr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildInvoke")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildUnwind")>]
        extern void* (* LLVMValueRef *) buildUnwindNative(
            void* (* LLVMBuilderRef *) arg0)
        let buildUnwind _arg0 =
            new ValueRef (buildUnwindNative ((_arg0 : BuilderRef).Ptr))

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildUnreachable")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddCase")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddDestination")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildAdd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNSWAdd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNUWAdd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFAdd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNSWSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNUWSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFSub")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNSWMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNUWMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFMul")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildUDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildExactSDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFDiv")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildURem")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSRem")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFRem")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildShl")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildLShr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildAShr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildAnd")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildOr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildXor")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildBinOp")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNeg")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNSWNeg")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNUWNeg")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFNeg")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildNot")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildMalloc")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildArrayMalloc")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildAlloca")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildArrayAlloca")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFree")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildLoad")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildStore")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildGEP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildInBoundsGEP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildStructGEP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildGlobalString")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildGlobalStringPtr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildTrunc")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildZExt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSExt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFPToUI")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFPToSI")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildUIToFP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSIToFP")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFPTrunc")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFPExt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildPtrToInt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildIntToPtr")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildZExtOrBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSExtOrBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildTruncOrBitCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildPointerCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildIntCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFPCast")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildICmp")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildFCmp")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildPhi")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildCall")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildSelect")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildVAArg")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildExtractElement")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildInsertElement")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildShuffleVector")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildExtractValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildInsertValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildIsNull")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildIsNotNull")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMBuildPtrDiff")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateModuleProviderForExistingModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposeModuleProvider")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateMemoryBufferWithContentsOfFile")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateMemoryBufferWithSTDIN")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposeMemoryBuffer")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetGlobalPassRegistry")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreatePassManager")>]
        extern void* (* LLVMPassManagerRef *) createPassManagerNative()
        let createPassManager () =
            new PassManagerRef (createPassManagerNative ())

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateFunctionPassManagerForModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateFunctionPassManager")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRunPassManager")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInitializeFunctionPassManager")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRunFunctionPassManager")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMFinalizeFunctionPassManager")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposePassManager")>]
...
namespace LLVM.Generated
    ...
    module BitReader =
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMParseBitcode")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMParseBitcodeInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetBitcodeModuleInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetBitcodeModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetBitcodeModuleProviderInContext")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetBitcodeModuleProvider")>]
...
namespace LLVM.Generated
    ...
    module BitWriter =
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMWriteBitcodeToFile")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMWriteBitcodeToFD")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMWriteBitcodeToFileHandle")>]
...
namespace LLVM.Generated
    ...
    module Target =
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateTargetData")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddTargetData")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCopyStringRepOfTargetData")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMStoreSizeOfType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMABISizeOfType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMABIAlignmentOfType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCallFrameAlignmentOfType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMPreferredAlignmentOfType")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMPreferredAlignmentOfGlobal")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMElementAtOffset")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMOffsetOfElement")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMInvalidateStructLayout")>]
        extern void invalidateStructLayoutNative(
            void* (* LLVMTargetDataRef *) arg0,
            void* (* LLVMTypeRef *) StructTy)
        let invalidateStructLayout _arg0 _StructTy =
            invalidateStructLayoutNative ((_arg0 : TargetDataRef).Ptr, (_StructTy : TypeRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposeTargetData")>]
...
namespace LLVM.Generated
    ...
    module ExecutionEngine =
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMLinkInJIT")>]
        extern void linkInJITNative()
        let linkInJIT () =
            linkInJITNative ()

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMLinkInInterpreter")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateGenericValueOfInt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateGenericValueOfPointer")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateGenericValueOfFloat")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGenericValueIntWidth")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGenericValueToInt")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposeGenericValue")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateExecutionEngineForModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateInterpreterForModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateJITCompilerForModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateExecutionEngine")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateInterpreter")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMCreateJITCompiler")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMDisposeExecutionEngine")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRunStaticConstructors")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRunFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMFreeMachineCodeForFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddModuleProvider")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRemoveModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRemoveModuleProvider")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMFindFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMRecompileAndRelinkFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetExecutionEngineTargetData")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddGlobalMapping")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMGetPointerToGlobal")>]
...
namespace LLVM.Generated
    ...
    module Analysis =
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMVerifyModule")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMVerifyFunction")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMViewFunctionCFG")>]
        extern void viewFunctionCFGNative(
            void* (* LLVMValueRef *) Fn)
        let viewFunctionCFG _Fn =
            viewFunctionCFGNative ((_Fn : ValueRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMViewFunctionCFGOnly")>]
...
namespace LLVM.Generated.Transforms
    ...
    module Scalar =
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddAggressiveDCEPass")>]
        extern void addAggressiveDCEPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addAggressiveDCEPass _PM =
            addAggressiveDCEPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddCFGSimplificationPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddDeadStoreEliminationPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddScalarReplAggregatesPassWithThreshold")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddSimplifyLibCallsPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddTailCallEliminationPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddConstantPropagationPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddDemoteMemoryToRegisterPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddVerifierPass")>]
...
namespace LLVM.Generated.Transforms
    ...
    module IPO =
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddArgumentPromotionPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddConstantMergePass")>]
        extern void addConstantMergePassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addConstantMergePass _PM =
            addConstantMergePassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddDeadArgEliminationPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddDeadTypeEliminationPass")>]
        extern void addDeadTypeEliminationPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addDeadTypeEliminationPass _PM =
            addDeadTypeEliminationPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddFunctionAttrsPass")>]
        extern void addFunctionAttrsPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addFunctionAttrsPass _PM =
            addFunctionAttrsPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddFunctionInliningPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddGlobalDCEPass")>]
        extern void addGlobalDCEPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addGlobalDCEPass _PM =
            addGlobalDCEPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddGlobalOptimizerPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddIPConstantPropagationPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddLowerSetJmpPass")>]
        extern void addLowerSetJmpPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addLowerSetJmpPass _PM =
            addLowerSetJmpPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddPruneEHPass")>]
        extern void addPruneEHPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addPruneEHPass _PM =
            addPruneEHPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddIPSCCPPass")>]
        extern void addIPSCCPPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addIPSCCPPass _PM =
            addIPSCCPPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddInternalizePass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddRaiseAllocationsPass")>]
        extern void addRaiseAllocationsPassNative(
            void* (* LLVMPassManagerRef *) PM)
        let addRaiseAllocationsPass _PM =
            addRaiseAllocationsPassNative ((_PM : PassManagerRef).Ptr)

        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddStripDeadPrototypesPass")>]
        ...
        [<DllImport("LLVM-2.9.dll", EntryPoint="LLVMAddStripSymbolsPass")>]
